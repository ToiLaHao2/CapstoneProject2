...
// message
const validateGetNotification = validator("getNotification");
const validateMarkNotiRead = validator("markNotificationRead");
const validateAllNotiRead = validator("markAllRead");

module.exports = {
    validateGetNotification,
    validateMarkNotiRead,
    validateAllNotiRead
}
